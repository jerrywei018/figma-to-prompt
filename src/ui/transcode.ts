 ...
 * over JPG quality) we ask the sandbox for a PNG source and transcode via
 * `<canvas>.toBlob` in the UI iframe.
 *
 ...
 *  result. PNG / SVG are passthrough; JPG / WebP / AVIF must go through canvas. */
